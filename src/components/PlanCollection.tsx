  ...
  return (
    <div className="h-full flex flex-col max-w-7xl mx-auto w-full">
      <div className="flex items-end justify-between mb-10">
        <div>
          <h2 className="text-4xl font-bold text-gray-900 tracking-tighter mb-2">Design Gallery</h2>
          <p className="text-xs font-bold text-gray-400 uppercase tracking-widest">Explore beautiful floor plans</p>
        </div>
        
        <div className="flex items-center gap-4">
          <div className="bg-white px-6 py-3 rounded-2xl border border-gray-100 flex items-center gap-4 soft-shadow">
            <Search className="w-4 h-4 text-gray-300" />
            <input 
              type="text" 
              placeholder="Search styles..." 
              className="bg-transparent border-none focus:outline-none text-sm font-medium text-gray-900 placeholder:text-gray-300"
            />
          </div>
          <button className="w-12 h-12 bg-white rounded-2xl border border-gray-100 flex items-center justify-center hover:bg-gray-50 transition-colors soft-shadow">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 overflow-y-auto custom-scrollbar pr-2 pb-10">
        {PLANS.map((plan, i) => (
          <motion.div
            ...
            className="group bg-white border border-gray-100 rounded-[2.5rem] overflow-hidden flex flex-col transition-all soft-shadow hover:shadow-[0_20px_50px_rgba(0,0,0,0.08)]"
          >
            <div className="h-56 relative overflow-hidden">
              ...
              <div className="absolute top-4 right-4 flex gap-2">
                <button className="w-10 h-10 rounded-xl bg-white/90 backdrop-blur-md flex items-center justify-center text-gray-400 hover:text-orange-500 transition-all shadow-sm">
              ...
              <div className="mt-auto pt-8 border-t border-gray-50 flex items-center justify-between">
                <div className="flex items-center gap-8">
                  <div>
                    ...
                    <p className="text-sm font-bold text-gray-900">{plan.stats.rooms}</p>
                  </div>
                  <div className="w-px h-8 bg-gray-50" />
                  <div>
                    <p className="text-[10px] font-bold text-gray-300 uppercase tracking-widest mb-1">Area</p>
                    <p className="text-sm font-bold text-gray-900">{plan.stats.area}</p>
                  </div>
                </div>
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.9 }}
                  className="w-12 h-12 rounded-2xl bg-gray-900 text-white flex items-center justify-center shadow-lg hover:bg-gray-800 transition-all"
                >
